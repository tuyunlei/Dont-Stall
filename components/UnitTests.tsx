                        ...
                        {(groupTests as TestResult[]).map(test => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0 pr-2">
                                    ...
                                    <div className="text-sm font-medium text-slate-400 truncate">{t(test.name)}</div>
                                </div>
                    ...
                    <>
                        ...
                        <div className="p-6 border-b border-slate-800 bg-slate-900/50">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h1 className="text-2xl font-bold text-white mb-2">{t(selectedTest.name)}</h1>
                                    <p className="text-slate-400">{t(selectedTest.description)}</p>
                                </div>
                            ...
                            {!selectedTest.passed && (selectedTest.error || selectedTest.errorL10n) && (
                                <div className="mb-6 p-4 bg-red-950/30 border border-red-900/50 rounded-lg text-red-200 font-mono text-sm">
                                    <strong className="text-red-500 block mb-1">{t('tests.assertion_fail')}</strong>
