...
export const DYNAMIC_SCENARIOS: TestDefinition[] = [
    {
        ...
        run: (ctx: ScenarioContext) => {
            ...
            // Clutch held, Brakes released
            ctx.simulate(60, { clutch: true, brake: false });
            ...
            // Hard reset velocity for the launch phase of the test to ensure consistency
            ctx.state.localVelocity.x = 0;
            ctx.state.rpm = 2500;
            // Immediate clutch dump for launch power test
